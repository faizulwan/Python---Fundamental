...
# MENU UTAMA
provinsi = ['Nanggroe Aceh Darussalam', 'Sumatera Utara', 'Sumatera Barat', 'Riau', 'Kepulauan Riau', 'Jambi', 'Bengkulu', 'Sumatera Selatan', 'Kepualauan Bangka', 'Lampung', 'Banten', 'Jakarta', 'Jawa Barad', 'Jawa Barad', 'Jawa Tengah', 'Jawa Timur', 'DI Yogyakarta', 'Bandung']
